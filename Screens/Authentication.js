...
import {View, StyleSheet, TouchableOpacity, Alert, TextInput, Image, Text, Modal, ScrollView, KeyboardAvoidingView} from 'react-native';
...
export default class Authentication extends React.Component{
    ...
    login = async(email, password) => {
        try{
            ...
            then(() => {
               this.props.navigation.navigate("Nowhere") 
            })
        }
                  ...
                  <TextInput style = {styles.formTextInput}
                    ...
                    <TouchableOpacity style = {styles.cancelButton}
                      onPress = {() => 
                          ...
                          <Text style = {{color: '#ff5722'}}>Cancel (At Your Own Risk)</Text>
            ...
            <View style = {styles.container}>
                ...
                <View style = {{justifyContent: 'center', alignItems: 'center'}}>
                  ...
                  <View>
                     ...
                     <TextInput style = {styles.input}
                      secureTextEntry = {true}
                      placeholder = "Enter 'Password' (Or Evil Fake Name)"
                      placeholderTextColor = "#ffffff"
                      onChangeText = {(text) => {
                        this.setState({
                            password: text
